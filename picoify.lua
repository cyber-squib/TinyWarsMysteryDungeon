...
function rnd() -- needs implementation for proto port

end

function mset() -- needs implementation for proto port

end

function ceil() -- needs implementation for proto port

end

function fget() -- needs implementation for proto port

end

function map() -- needs implementation for proto port

end

function getmetatable() -- needs implementation for proto port

end

function setmetatable() -- needs implementation for proto port

end

function vid() -- needs implementation for proto port

end

function assert() -- needs implementation for proto port

end

function line() -- needs implementation for proto port
